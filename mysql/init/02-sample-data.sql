...
INSERT INTO `users` (`id`, `firstName`, `lastName`, `email`, `mobile`, `role`, `balanceCents`, `createdAt`, `updatedAt`) VALUES
('admin-uuid-bcmarl-2025', 'Max', 'Mustermann', 'admin@bcmarl.de', '01234567890', 'admin', 10000, NOW(), NOW());

-- Insert sample users
INSERT INTO `users` (`id`, `firstName`, `lastName`, `email`, `mobile`, `role`, `balanceCents`, `lowBalanceThresholdCents`, `createdAt`, `updatedAt`) VALUES
('user-anna-uuid-001', 'Anna', 'Schmidt', 'anna@example.com', '01111111111', 'user', 2500, 500, NOW(), NOW()),
('user-tom-uuid-002', 'Tom', 'Müller', 'tom@example.com', '02222222222', 'user', 1800, 500, NOW(), NOW()),
...
INSERT INTO `products` (`id`, `name`, `icon`, `priceCents`, `category`, `active`, `createdAt`, `updatedAt`) VALUES
-- Getränke
('prod-pils-uuid-001', 'Pils 0,5l', '🍺', 250, 'DRINKS', TRUE, NOW(), NOW()),
('prod-cola-uuid-002', 'Cola 0,33l', '🥤', 180, 'DRINKS', TRUE, NOW(), NOW()),
('prod-wasser-uuid-003', 'Mineralwasser 0,5l', '💧', 120, 'DRINKS', TRUE, NOW(), NOW()),
('prod-kaffee-uuid-004', 'Kaffee', '☕', 150, 'DRINKS', TRUE, NOW(), NOW()),
('prod-apfelsaft-uuid-005', 'Apfelsaft 0,25l', '🧃', 160, 'DRINKS', TRUE, NOW(), NOW()),

-- Snacks  
('prod-erdnuesse-uuid-006', 'Erdnüsse gesalzen', '🥜', 200, 'SNACKS', TRUE, NOW(), NOW()),
('prod-chips-uuid-007', 'Chips Paprika', '🍿', 150, 'SNACKS', TRUE, NOW(), NOW()),
('prod-schoko-uuid-008', 'Schokoriegel', '🍫', 120, 'SNACKS', TRUE, NOW(), NOW()),
('prod-brezel-uuid-009', 'Brezel', '🥨', 80, 'SNACKS', TRUE, NOW(), NOW()),

-- Zubehör
('prod-tshirt-uuid-010', 'Vereins T-Shirt M', '👕', 1500, 'ACCESSORIES', TRUE, NOW(), NOW()),
('prod-kappe-uuid-011', 'Vereinskappe', '🧢', 800, 'ACCESSORIES', TRUE, NOW(), NOW()),
('prod-aufkleber-uuid-012', 'Aufkleber Set', '🏷️', 300, 'ACCESSORIES', TRUE, NOW(), NOW()),

-- Mitgliedschaften
('prod-jahr-uuid-013', 'Jahresmitgliedschaft Erwachsene', '🎫', 5000, 'MEMBERSHIP', TRUE, NOW(), NOW()),
('prod-familie-uuid-014', 'Familienmitgliedschaft', '👨‍👩‍👧‍👦', 8000, 'MEMBERSHIP', TRUE, NOW(), NOW());
